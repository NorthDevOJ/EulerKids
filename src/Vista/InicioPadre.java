 ...
 * @author perfil
 */
public class InicioPadre extends javax.swing.JFrame {

        private LinkedList<String> padres = new LinkedList<>(); 
        public static String identificacionPadre = "";
        
    /**
     * Creates new form InicioPadre
     */
    public InicioPadre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        root.add(btnEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 370, 260, 48));
        ...
        root.add(btnInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 470, 110, 40));
        ...
        root.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 330, 300, 40));

        txtContraseña.setBackground(new java.awt.Color(238, 238, 238));
        txtContraseña.setBorder(null);
        root.add(txtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 410, 280, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/login padre.png"))); // NOI18N
        root.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioPadre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioPadre().setVisible(true);
            }
        });
    }
